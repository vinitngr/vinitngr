...
const ExperienceCard: React.FC<Experience> = ({
    ...
    return (
        <div className="w-full border-b sm:border-t border-[#1a1a22] sm:border-[#2d2d3a]  sm:bg-[#1A1A22]/50 bg-[#1A1A22]/20 relative rounded-xs cursor-pointer group hover:border-orange-400  sm:p-4 p-2 px-4 transition-all duration-300"
